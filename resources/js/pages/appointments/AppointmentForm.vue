                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input v-model="form.start_time" type="text" class="form-control flatpicker" :class="{'is-invalid': errors.start_time}" id="start-time">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input v-model="form.end_time" type="text" class="form-control flatpicker" :class="{'is-invalid': errors.end_time}" id="end-time">
    ...
    const createAppointment = (values, actions) => {
        axios.post('/api/appointments/create', form)
            .then((response) => {
                ...
                toastr.success('New appointment created successfully');
            })
            .catch((error) => {
